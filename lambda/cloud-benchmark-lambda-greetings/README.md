# cloud-benchmark-lambda-greetings project
...
You can then execute your native executable with: `./target/cloud-benchmark-lambda-greetings-1.0.0-SNAPSHOT-runner`
